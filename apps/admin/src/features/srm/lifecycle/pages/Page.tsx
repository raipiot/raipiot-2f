...
export function Page() {
  ...
  const {
    data: { records, total }
  } = useSuspenseQuery(LifeCycle.listQO(PageUtils.mergeParams(pageParams)))
          ...
          menu={{
            items: lifecycleOptions
              ...
              .map((i) => ({
                ...
                label: (
                  <Link
                    to="/srm/lifecycle/supplier/application-form/create"
                    search={{
                      upgrade: i.value > record.relegationStatus!,
